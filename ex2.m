...
[theta, cost] = fminunc(@(t)(costFunction(t, X, y)), initial_theta, options); # here t is theta which is adjusted by the fminunc function. @t indicates that t needs to be changed in each iteration 
